...
https://en.wikipedia.org/wiki/ISO_8601[ISO-8601] date-string, which is
then parsed using Java's
https://docs.oracle.com/javase/8/docs/api/java/time/ZonedDateTime.html[ZonedDateTime].
