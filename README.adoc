...
Core2 implements a dynamic schema model (i.e. no explicit https://en.wikipedia.org/wiki/Data_manipulation_language[DML] is required) and allows for relational querying across nested, document-shaped data.
