...
https://github.com/xtdb/core2/tree/master/doc/adoc[Preliminary documentation] exists.
This documentation is (intentionally) not published yet, but you can
https://github.com/xtdb/core2/tree/master/doc/adoc#build[build the documentation yourself].
