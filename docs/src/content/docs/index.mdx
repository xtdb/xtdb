...
To discover the novel features of XTDB, take a look at the interactive [SQL Quickstart](/intro/getting-started).

Or alternatively, if you would prefer to get XTDB running locally via Docker before following the Quickstart, follow the steps [here](/intro/installation-via-docker).
