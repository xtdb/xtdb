...
Download the JSON template: https://github.com/xtdb/xtdb/blob/main/monitoring/public-dashboards/xtdb-monitoring.json[here].
...
Download the JSON template: https://github.com/xtdb/xtdb/blob/main/monitoring/public-dashboards/xtdb-node-debugging.json[here].
