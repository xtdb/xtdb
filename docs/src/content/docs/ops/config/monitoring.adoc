...
XTDB provides https://github.com/xtdb/xtdb/tree/main/monitoring/public-dashboards[pre-built Grafana dashboards^] for monitoring the health and performance of XTDB clusters and individual nodes.
