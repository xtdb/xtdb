...
- **OpenID Connect** (`!OpenIdConnect`): Integrates with enterprise identity providers like Keycloak, Auth0, or Azure AD
...
The `!OpenIdConnect` authentication method integrates with enterprise identity providers like Keycloak, Auth0, or Azure AD.
