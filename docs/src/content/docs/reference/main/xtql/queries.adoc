...
Where link:#_binding_specs[bindings] specify how to join the _output_ of the sub-query to the outer query, arguments specify the _inputs_ to the sub-query from the outer query.
