...
:openapi: /drivers/openapi/index.html

NOTE: For specific details of how to submit XTQL queries, see the documentation for your individual link:/reference/main/drivers[client library].
...
link:{openapi}#model-Aggregate[JSON Aggregate spec]
...
link:{openapi}#model-From[JSON From spec]
...
link:{openapi}#model-TemporalFilter[JSON TemporalFilter spec]
...
link:{openapi}#model-Join[JSON Join spec] +
link:{openapi}#model-LeftJoin[JSON LeftJoin spec]
...
link:{openapi}#model-Limit[JSON Limit spec]
...
link:{openapi}#model-Offset[JSON Offset spec]
...
link:{openapi}#model-OrderBy[JSON OrderBy spec] +
link:{openapi}#model-OrderSpec[JSON OrderSpec spec]
...
link:{openapi}#model-Return[JSON Return spec]
...
link:{openapi}#model-Rel[JSON Rel(ation) spec]
...
link:{openapi}#model-Unify[JSON Unify spec]
...
link:{openapi}#model-Unnest[JSON Unnest spec]
...
link:{openapi}#model-Where[JSON Where spec]
...
link:{openapi}#model-With[JSON With spec]
...
link:{openapi}#model-Without[JSON Without spec]
...
link:{openapi}#model-Expr[JSON Expr spec] +
link:{openapi}#model-LogicVar[JSON LogicVar spec] +
link:{openapi}#model-Param[JSON Param spec] +
link:{openapi}#model-Call[JSON Expr Call spec] +
link:{openapi}#model-ExprGet[JSON Expr Get spec] +
link:{openapi}#model-ExprQuery[JSON Subquery spec] +
link:{openapi}#model-ExprExists[JSON Exists spec] +
link:{openapi}#model-ExprPull[JSON Pull spec] +
link:{openapi}#model-ExprPullMany[JSON PullMany spec] +
link:{openapi}#model-ExprSet[JSON Expr set spec] +
link:{openapi}#model-ExprList[JSON Expr List spec]
...
link:{openapi}#model-Binding[JSON Binding spec]
...
link:{openapi}#model-Binding[JSON Argument spec]. +
