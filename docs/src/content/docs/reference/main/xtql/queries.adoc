...
title: XTQL Queries
---
:examples:  ../src/test/resources/docs/xtql_json_examples.yaml
:openapi: /drivers/http/openapi/index.html

NOTE: For specific details of how to submit XTQL queries, see the documentation for your individual link:/drivers[client library].
...
[%collapsible%open]
====
link:{openapi}#/schemas/Aggregate[JSON Aggregate spec]

[source,json]
----
include::{examples}[tags=aggr-json,indent=0]
----
====
...
link:{openapi}#/schemas/From[JSON From spec]

[source,json]
----
include::{examples}[tags=from-json,indent=0]
----
====
...
[source,json]
----
include::{examples}[tags=from-star-json,indent=0]
----
====
...
[source,json]
----
include::{examples}[tags=star-invalid-json,indent=0]
----
====
...
link:{openapi}#/schemas/TemporalFilter[JSON TemporalFilter spec]

[source,json]
----
include::{examples}[tags=temporal-filters-json,indent=0]
----
====
...
link:{openapi}#/schemas/Join[JSON Join spec] +
link:{openapi}#/schemas/LeftJoin[JSON LeftJoin spec]

[source,json]
----
include::{examples}[tags=joins-json,indent=0]
----
====
...
link:{openapi}#/schemas/Limit[JSON Limit spec]

[source,json]
----
include::{examples}[tags=limit-json,indent=0]
----
====
...
link:{openapi}#/schemas/Offset[JSON Offset spec]

[source,json]
----
include::{examples}[tags=offset-json,indent=0]
----
====
...
link:{openapi}#/schemas/OrderBy[JSON OrderBy spec] +
link:{openapi}#/schemas/OrderSpec[JSON OrderSpec spec]

[source,json]
----
include::{examples}[tags=order-by-json,indent=0]
----
====
...
link:{openapi}#/schemas/Return[JSON Return spec]

[source,json]
----
include::{examples}[tags=return-json,indent=0]
----
====
...
link:{openapi}#/schemas/Rel[JSON Rel(ation) spec]

[source,json]
----
include::{examples}[tags=rel-json,indent=0]
----
====
...
link:{openapi}#/schemas/Unify[JSON Unify spec]

[source,json]
----
include::{examples}[tags=unify-json,indent=0]
----
====
...
link:{openapi}#/schemas/Unnest[JSON Unnest spec]

[source,json]
----
include::{examples}[tags=unnest-json,indent=0]
----
====
...
link:{openapi}#/schemas/Where[JSON Where spec]

[source,json]
----
include::{examples}[tags=where-json,indent=0]
----
====
...
link:{openapi}#/schemas/With[JSON With spec]

[source,json]
----
include::{examples}[tags=with-json,indent=0]
----
====
...
link:{openapi}#/schemas/Without[JSON Without spec]

[source,json]
----
include::{examples}[tags=without-json,indent=0]
----
====
...
link:{openapi}#/schemas/Expr[JSON Expr spec] +
link:{openapi}#/schemas/LogicVar[JSON LogicVar spec] +
link:{openapi}#/schemas/Param[JSON Param spec] +
link:{openapi}#/schemas/Call[JSON Expr Call spec] +
link:{openapi}#/schemas/ExprGet[JSON Expr Get spec] +
link:{openapi}#/schemas/ExprQuery[JSON Subquery spec] +
link:{openapi}#/schemas/ExprExists[JSON Exists spec] +
link:{openapi}#/schemas/ExprPull[JSON Pull spec] +
link:{openapi}#/schemas/ExprPullMany[JSON PullMany spec] +
link:{openapi}#/schemas/ExprSet[JSON Expr set spec] +
link:{openapi}#/schemas/ExprList[JSON Expr List spec]

The following example retrieves a post together with their author and comments:

[source,json]
----
include::{examples}[tags=expr-json-1,indent=0]
----
====
...
link:{openapi}#/schemas/Binding[JSON Binding spec]
...
[source,json]
----
include::{examples}[tags=binding-json-1,indent=0]
----
+
...
[source,json]
----
include::{examples}[tags=binding-json-2,indent=0]
----
* We can constrain rows by specifying literals or parameters.
+
[source,json]
----
include::{examples}[tags=binding-json-3,indent=0]
----
...
link:{openapi}#/schemas/Binding[JSON Argument spec]. +
Arguments and Bindings share thier schema.

[source,json]
----
include::{examples}[tags=argument-json-1,indent=0]
----
====
...
[source,json]
----
include::{examples}[tags=argument-json-2,indent=0]
----
====
