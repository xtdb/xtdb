...
This document provides examples for EDN transaction operations, to be submitted to link:{codox}/xtdb.api.html#var-execute-tx[`xt/execute-tx`^] or link:{codox}/xtdb.api.html#var-submit-tx[`xt/submit-tx`^].
