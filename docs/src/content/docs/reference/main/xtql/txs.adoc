...
This document provides examples for EDN transaction operations, to be submitted to link:/clients/clojure/codox/xtdb.api.html#var-execute-tx[`xt/execute-tx`] or link:/clients/clojure/codox/xtdb.api.html#var-submit-tx[`xt/submit-tx`].
