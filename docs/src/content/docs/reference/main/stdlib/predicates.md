...
- These apply to any data types that are naturally comparable:
    numbers, strings, date-times, durations, etc.

- XTDB predicates all use [three-valued
    logic](https://en.wikipedia.org/wiki/Three-valued_logic), as per the
    SQL spec - unless otherwise specified, if any input expression is
