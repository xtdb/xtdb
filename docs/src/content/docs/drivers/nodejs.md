...
In NodeJS, you can talk to a running XTDB node using the ['Postgres.js'](https://www.npmjs.com/package/postgres) package, taking advantage of XTDB's PostgreSQL wire-compatibility.
