...
In Elixir, you can talk to a running XTDB node using the
[Postgrex](https://github.com/elixir-ecto/postgrex) driver and XTDB's
Postgres wire-compatibility.

## Install

To install the Postgrex driver, add the following dependency to your
Elixir project's `mix.exs`:
