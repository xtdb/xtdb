...
The question our own investors are now demanding an answer to, though, is how much we just lost because of those products compared with selling them _before_ they ended up on XY Bank's balance sheet.
...
Ah, see there: the audit information shows that we only started recording product owner changes recently.
