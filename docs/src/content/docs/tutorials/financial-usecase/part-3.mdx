...
Ok, now we know when we should have ideally sold and we can combine that with our prices to get how much we lost.

We'll also now be a good position to easily keep track of when products change ownership, and other impacts of corporate actions, so we can more easily answer key investor questions like that in future.
