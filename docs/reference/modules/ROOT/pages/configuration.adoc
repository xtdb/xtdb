...
include::example$test/crux/docs/examples/configuration/ConfigurationTest.java[tags=from-file-0,indent=0]
include::example$test/crux/docs/examples/configuration/ConfigurationTest.java[tags=from-file-1,indent=0]
