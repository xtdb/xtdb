...
See the https://github.com/xtdb/xtdb/blob/master/modules/lucene/test/xtdb/lucene/extension_test.clj[extension tests] for examples of decoding the contents of the result document and performing userspace temporal filtering.
...
See the https://github.com/xtdb/xtdb/blob/master/modules/lucene/test/xtdb/lucene/extension_test.clj[extension tests] for examples.
...
See the https://github.com/xtdb/xtdb/blob/master/modules/lucene/test/xtdb/lucene/extension_test.clj[extension tests] for an example of configuring multiple Lucene modules to run on the same node.
