...
See the https://github.com/xtdb/xtdb/blob/master/modules/lucene/test/crux/lucene/extension_test.clj[extension tests] for examples of decoding the contents of the result document and performing userspace temporal filtering.
...
See the https://github.com/xtdb/xtdb/blob/master/modules/lucene/test/crux/lucene/extension_test.clj[extension tests] for examples.
...
See the https://github.com/xtdb/xtdb/blob/master/modules/lucene/test/crux/lucene/extension_test.clj[extension tests] for an example of configuring multiple Lucene modules to run on the same node.
...
----
{
  "xtdb.lucene/index-store": {
    "db-dir": "lucene-dir",
    "checkpointer": {
      "xt/module": "xtdb.checkpoint/->checkpointer",
      "store": {
        "xt/module": "xtdb.checkpoint/->filesystem-checkpoint-store",
...
----
{:xtdb.lucene/lucene-store {:db-dir "lucene-dir"
                            :checkpointer {:xt/module 'xtdb.checkpoint/->checkpointer
                                           :store {:xt/module 'xtdb.checkpoint/->filesystem-checkpoint-store
                                                   :path "/path/to/cp-store"}
