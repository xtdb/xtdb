...
[source,clojure]
----
include::example$src/docs/examples.clj[tags=eql-project]
include::example$src/docs/examples.clj[tags=eql-project-r]
include::example$src/docs/examples.clj[tags=eql-project-many]
include::example$src/docs/examples.clj[tags=eql-project-many-r]
----
