...
[source,clojure]
----
include::example$test/crux/docs/examples_test.clj[tags=anatomy]
----
...
[source,clj]
----
include::example$test/crux/docs/examples_test.clj[tags=triple]
----
...
[source,clj]
----
include::example$test/crux/docs/examples_test.clj[tags=query-aggregates]

include::example$test/crux/docs/examples_test.clj[tags=query-aggregates-r]
----
...
[source,clojure]
----
include::example$test/crux/docs/examples_test.clj[tags=eql-query-1]
include::example$test/crux/docs/examples_test.clj[tags=eql-query-1-r]

include::example$test/crux/docs/examples_test.clj[tags=eql-query-2]
include::example$test/crux/docs/examples_test.clj[tags=eql-query-2-r]
----
...
[source,clojure]
----
include::example$test/crux/docs/examples_test.clj[tags=eql-query-3]
include::example$test/crux/docs/examples_test.clj[tags=eql-query-3-r]

include::example$test/crux/docs/examples_test.clj[tags=eql-query-4]
include::example$test/crux/docs/examples_test.clj[tags=eql-query-4-r]
----
...
[source,clojure]
----
include::example$test/crux/docs/examples_test.clj[tags=eql-query-5]
include::example$test/crux/docs/examples_test.clj[tags=eql-query-5-r]
----
...
[source,clojure]
----
include::example$test/crux/docs/examples_test.clj[tags=eql-query-6]
include::example$test/crux/docs/examples_test.clj[tags=eql-query-6-r]
----
...
[source,clj]
----
include::example$test/crux/docs/examples_test.clj[tags=double]

include::example$test/crux/docs/examples_test.clj[tags=triple-2]

include::example$test/crux/docs/examples_test.clj[tags=triple-3]
----
...
[source,clj]
----
include::example$test/crux/docs/examples_test.clj[tags=not-data]

include::example$test/crux/docs/examples_test.clj[tags=not-2]

include::example$test/crux/docs/examples_test.clj[tags=not-2-r]
----
<1> Data
<2> Query
<3> Result
...
[source,clj]
----
include::example$test/crux/docs/examples_test.clj[tags=not-join-data]

include::example$test/crux/docs/examples_test.clj[tags=not-join]

include::example$test/crux/docs/examples_test.clj[tags=not-join-r]
----
<1> Data
...
[source,clj]
----
include::example$test/crux/docs/examples_test.clj[tags=or-data]

include::example$test/crux/docs/examples_test.clj[tags=or-1]

include::example$test/crux/docs/examples_test.clj[tags=or-1-r]
----
<1> Data
<2> Query
<3> Result
...
When within an `or` term, you can use `and` to group terms which must all be true.

[source,clj]
----
include::example$test/crux/docs/examples_test.clj[tags=or-2]
----
...
[source,clj]
----
include::example$test/crux/docs/examples_test.clj[tags=or-join-data]

include::example$test/crux/docs/examples_test.clj[tags=or-join]

include::example$test/crux/docs/examples_test.clj[tags=or-join-r]
----
<1> Data
<2> Declaration of which logic variables need to unify with the rest of the query
<3> Terms
...
[source,clj]
----
include::example$test/crux/docs/examples_test.clj[tags=range-1]

include::example$test/crux/docs/examples_test.clj[tags=range-2]

include::example$test/crux/docs/examples_test.clj[tags=range-3]
----
...
[source,clojure]
----
include::example$test/crux/docs/examples_test.clj[tags=query-with-pred-1]
----
...
You can nest a subquery with a `:where` term to bind the result for further use in the query.

==== Binding results as a scalar

[source,clj]
----
include::example$test/crux/docs/examples_test.clj[tags=sub-query-example-1]
----
...
[source,clj]
----
include::example$test/crux/docs/examples_test.clj[tags=sub-query-example-1-r]
----
...
[source,clj]
----
include::example$test/crux/docs/examples_test.clj[tags=sub-query-example-2]
----
...
[source,clj]
----
include::example$test/crux/docs/examples_test.clj[tags=sub-query-example-2-r]
----
...
[source,clj]
----
include::example$test/crux/docs/examples_test.clj[tags=sub-query-example-3]
----
...
[source,clj]
----
include::example$test/crux/docs/examples_test.clj[tags=sub-query-example-3-r]
----
...
[source,clj]
----
include::example$test/crux/docs/examples_test.clj[tags=query-with-arguments1]
----
...
[source,clj]
----
include::example$test/crux/docs/examples_test.clj[tags=query-with-arguments1-r]
----
...
[source,clj]
----
include::example$test/crux/docs/examples_test.clj[tags=query-with-arguments2]
----
...
[source,clj]
----
include::example$test/crux/docs/examples_test.clj[tags=query-with-arguments2-r]
----
...
[source,clj]
----
include::example$test/crux/docs/examples_test.clj[tags=query-with-arguments3]
----
...
[source,clj]
----
include::example$test/crux/docs/examples_test.clj[tags=query-with-arguments3-r]
----
...
[source,clj]
----
include::example$test/crux/docs/examples_test.clj[tags=query-with-arguments4]
----
...
[source,clj]
----
include::example$test/crux/docs/examples_test.clj[tags=query-with-arguments4-r]
----
...
[source,clj]
----
include::example$test/crux/docs/examples_test.clj[tags=order-and-pagination-1]
----
...
[source,clj]
----
include::example$test/crux/docs/examples_test.clj[tags=order-and-pagination-2]
----
...
[source,clj]
----
include::example$test/crux/docs/examples_test.clj[tags=order-and-pagination-3]
----
...
[#rules]
== Rules
Rules are defined by a signature and then terms as you would find in a `:where` statement.

They can be used as a shorthand for when you would otherwise be repeating the same restrictions in your `:where` statement.

[source,clojure]
----
include::example$test/crux/docs/examples_test.clj[tags=rules-1]
----
<1> Usage
<2> Rule signature
<3> Clauses
...
The terms in Rules can also use Rules. This allows for the recursive traversal of entities.

[source,clojure]
----
include::example$test/crux/docs/examples_test.clj[tags=rules-2]
----
...
[source,clojure]
----
include::example$test/crux/docs/examples_test.clj[tags=full-results-data]

include::example$test/crux/docs/examples_test.clj[tags=full-results-1]
include::example$test/crux/docs/examples_test.clj[tags=full-results-1-r]

include::example$test/crux/docs/examples_test.clj[tags=full-results-2]
include::example$test/crux/docs/examples_test.clj[tags=full-results-2-r]
----
...
[source,clj]
----
include::example$test/crux/docs/examples_test.clj[tags=query-at-t-d1]
include::example$test/crux/docs/examples_test.clj[tags=query-at-t-d2]
----
...
[source,clj]
----
include::example$test/crux/docs/examples_test.clj[tags=query-at-t-q1]
----
...
[source,clj]
----
include::example$test/crux/docs/examples_test.clj[tags=query-at-t-q1-q]

include::example$test/crux/docs/examples_test.clj[tags=query-at-t-q2-q]
----
...
[source,clj]
----
include::example$test/crux/docs/examples_test.clj[tags=join-d]
----

We can run a query to return a set of tuples that satisfy the join on the attribute `:name`
[source,clj]
----
include::example$test/crux/docs/examples_test.clj[tags=join-q]
----

Result Set:
[source,clj]
----
include::example$test/crux/docs/examples_test.clj[tags=join-r]
----
...
[source,clj]
----
include::example$test/crux/docs/examples_test.clj[tags=join2-d]
----

We can run a query to return a set of entities that `:follows` the set of entities with the `:name` value of `"Ivan"`
[source,clj]
----
include::example$test/crux/docs/examples_test.clj[tags=join2-q]
----

Result Set:
[source,clj]
----
include::example$test/crux/docs/examples_test.clj[tags=join2-r]
----
...
[source,clj,indent=0]
----
include::example$test/crux/docs/examples_test.clj[tags=streaming-query]
----
...
[source,clj]
----
include::example$test/crux/docs/examples_test.clj[tags=history-full]
----
...
[source,clj]
----
include::example$test/crux/docs/examples_test.clj[tags=history-with-docs]
----
...
[source,clj]
----
include::example$test/crux/docs/examples_test.clj[tags=history-range]
----
