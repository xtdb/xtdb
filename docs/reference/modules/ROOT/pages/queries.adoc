...
//See the https://github.com/juxt/crux/blob/master/test/test/crux/query_test.clj[`Crux query test file`] for the full suite of query tests and how each test listed below runs in the wider context.
...
Many examples of advanced queries are showcased across the https://github.com/juxt/crux/blob/master/test/test/crux/query_test.clj[query tests] and the suite of benchmarks maintained in the `crux-bench` sub-project.
