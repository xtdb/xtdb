...
[source,clojure]
----
include::example$src/docs/examples.clj[tags=anatomy]
----
...
[source,clj]
----
include::example$src/docs/examples.clj[tags=triple]
----
...
[source,clj]
----
include::example$src/docs/examples.clj[tags=query-aggregates]

include::example$src/docs/examples.clj[tags=query-aggregates-r]
----
...
[source,clj]
----
include::example$src/docs/examples.clj[tags=double]

include::example$src/docs/examples.clj[tags=triple-2]

include::example$src/docs/examples.clj[tags=triple-3]
----
...
[source,clj]
----
include::example$src/docs/examples.clj[tags=not-data]

include::example$src/docs/examples.clj[tags=not-2]

include::example$src/docs/examples.clj[tags=not-2-r]
----
<1> Data
<2> Query
<3> Result
...
[source,clj]
----
include::example$src/docs/examples.clj[tags=not-join-data]

include::example$src/docs/examples.clj[tags=not-join]

include::example$src/docs/examples.clj[tags=not-join-r]
----
<1> Data
...
[source,clj]
----
include::example$src/docs/examples.clj[tags=or-data]

include::example$src/docs/examples.clj[tags=or-1]

include::example$src/docs/examples.clj[tags=or-1-r]
----
<1> Data
<2> Query
<3> Result
...
[source,clj]
----
include::example$src/docs/examples.clj[tags=or-2]
----
...
[source,clj]
----
include::example$src/docs/examples.clj[tags=or-join-data]

include::example$src/docs/examples.clj[tags=or-join]

include::example$src/docs/examples.clj[tags=or-join-r]
----
<1> Data
<2> Declaration of which logic variables need to unify with the rest of the query
<3> Terms
...
[source,clj]
----
include::example$src/docs/examples.clj[tags=range-1]

include::example$src/docs/examples.clj[tags=range-2]

include::example$src/docs/examples.clj[tags=range-3]
----
...
[source,clojure]
----
include::example$src/docs/examples.clj[tags=rules-1]
----
<1> Usage
<2> Rule signature
<3> Clauses
...
[source,clojure]
----
include::example$src/docs/examples.clj[tags=rules-2]
----
...
[source,clojure]
----
include::example$src/docs/examples.clj[tags=full-results-data]

include::example$src/docs/examples.clj[tags=full-results-1]
include::example$src/docs/examples.clj[tags=full-results-1-r]

include::example$src/docs/examples.clj[tags=full-results-2]
include::example$src/docs/examples.clj[tags=full-results-2-r]
----
