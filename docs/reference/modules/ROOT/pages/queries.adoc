...
//See the https://github.com/xtdb/xtdb/blob/main/test/test/xtdb/query_test.clj[`XTDB query test file`] for the full suite of query tests and how each test listed below runs in the wider context.
...
Many examples of advanced queries are showcased across the https://github.com/xtdb/xtdb/blob/main/test/test/crux/query_test.clj[query tests] and the suite of benchmarks maintained in the `bench` sub-project.
