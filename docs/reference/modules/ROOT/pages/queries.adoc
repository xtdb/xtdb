...
[source,clojure]
----
include::example$test/crux/docs/examples/query_test.clj[tags=eql-query-1,indent=0]
include::example$test/crux/docs/examples/query_test.clj[tags=eql-query-1-r,indent=0]

include::example$test/crux/docs/examples/query_test.clj[tags=eql-query-2,indent=0]
include::example$test/crux/docs/examples/query_test.clj[tags=eql-query-2-r,indent=0]
----
...
[source,clojure]
----
include::example$test/crux/docs/examples/query_test.clj[tags=eql-project]
include::example$test/crux/docs/examples/query_test.clj[tags=eql-project-r]
include::example$test/crux/docs/examples/query_test.clj[tags=eql-project-many]
include::example$test/crux/docs/examples/query_test.clj[tags=eql-project-many-r]
----
...
[source,clojure]
----
include::example$test/crux/docs/examples/query_test.clj[tags=eql-query-3,indent=0]
include::example$test/crux/docs/examples/query_test.clj[tags=eql-query-3-r,indent=0]

include::example$test/crux/docs/examples/query_test.clj[tags=eql-query-4,indent=0]
include::example$test/crux/docs/examples/query_test.clj[tags=eql-query-4-r,indent=0]
----
...
[source,clojure]
----
include::example$test/crux/docs/examples/query_test.clj[tags=eql-query-5,indent=0]
include::example$test/crux/docs/examples/query_test.clj[tags=eql-query-5-r,indent=0]
----
...
[source,clojure]
----
include::example$test/crux/docs/examples/query_test.clj[tags=eql-query-6]
include::example$test/crux/docs/examples/query_test.clj[tags=eql-query-6-r]
----
...
Use of `:order-by` will typically require that results are fully-realised by the
query engine, however this happens transparently and it will automatically spill
to disk when sorting large numbers results. Ordered results are returned as
bags, not sets, so you may wish to deduplicate consecutive identical result
tuples (e.g. using `clojure.core/dedupe` or similar).
...
[source,clj]
----
include::example$test/crux/docs/examples/query_test.clj[tags=order-and-pagination-3,indent=0]
----
...
[source,clojure]
----
include::example$test/crux/docs/examples/query_test.clj[tags=full-results-data,indent=0]

include::example$test/crux/docs/examples/query_test.clj[tags=full-results-1,indent=0]
include::example$test/crux/docs/examples/query_test.clj[tags=full-results-1-r,indent=0]

include::example$test/crux/docs/examples/query_test.clj[tags=full-results-2,indent=0]
include::example$test/crux/docs/examples/query_test.clj[tags=full-results-2-r,indent=0]
----
...
See the https://github.com/juxt/crux/blob/master/crux-test/test/crux/query_test.clj[`Crux query test file`] for the full suite of query tests, which showcase many combinations of the query capabilities.
