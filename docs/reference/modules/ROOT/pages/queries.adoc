...
To gain a familiarity of Crux's underlying data model, see the xref:model.adoc[model] section.
...
referred to as "tuples". The possible values within the result tuples are derived from your database of
documents.
...
[source,clojure]
----
include::example$test/crux/docs/examples/query_test.clj[tags=eql-query-6,indent=0]
include::example$test/crux/docs/examples/query_test.clj[tags=eql-query-6-r,indent=0]
----
