...
We expose these via the https://github.com/xtdb/xtdb/blob/master/modules/s3/src/xtdb/s3/S3Configurator.java[`xtdb.s3.S3Configurator`] interface - you can supply an instance using the following in your node configuration.
