...
{:crux/document-store {:crux/module 'crux.kafka/->document-store
                       ...
                       :doc-topic-opts {:topic-name "crux-docs"
                                        ...}
                       :local-document-store {:kv-store {:crux/module 'crux.kv.rocksdb/->kv-store
                                                         :db-dir "/tmp/rocksdb"}}
                       :poll-wait-duration "PT1S"}
 ...}
----
...
----
{...
 :local-rocksdb {:crux/module 'crux.kv.rocksdb/->kv-store
                 :db-dir "/tmp/rocksdb"}
 :crux/document-store {...
                       :local-document-store {:kv-store :local-rocksdb}}
 :crux/indexer {:kv-store :local-rocksdb}}
----
