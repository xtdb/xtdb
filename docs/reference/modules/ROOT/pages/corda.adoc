...
This is a minimal configuration - see the main xref:configuration.adoc[Crux configuration] documentation for how to further configure the Crux node within the `startXtdbNode` block.
