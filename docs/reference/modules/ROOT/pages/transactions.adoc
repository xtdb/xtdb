...
Transaction functions are user-supplied functions that run on the individual XTDB nodes when a transaction is being ingested.
...
+
--
The document should use the `::xt/fn` key.
