...
include::example$src/docs/examples.clj[tags=start-in-memory-node,indent=0]
----
...
This will open an HTTP port with a console UI on port 3000 - head to http://localhost:3000[window=_blank] in your favourite browser.
...
{:deps {org.clojure/clojure {:mvn/version "1.10.1"}
        ...
        juxt/crux-cli {:mvn/version "20.09-1.11.0-beta"}}}
----
