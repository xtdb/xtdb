...
Crux pre-built JARs can be found on the relevant https://github.com/xtdb/xtdb/releases[GitHub releases,window=_blank] page - we'll use `crux-in-memory.jar`.
...
`docker run -p 3000:3000 juxt/crux-in-memory:1.18.1`
