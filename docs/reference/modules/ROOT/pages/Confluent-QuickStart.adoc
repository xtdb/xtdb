...
Use `confluent-hub install juxt/kafka-connect-crux:20.09-1.11.0-beta` to download and install the connector from Confluent hub. The downloaded connector is then placed within your confluent install's _'share/confluent-hub-components'_ folder. +
