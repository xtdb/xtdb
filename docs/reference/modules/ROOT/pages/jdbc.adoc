...
NOTE: The `crux-jdbc` module uses an embedded PostgreSQL instance and JDBC driver to support it. If you are connecting to an external PostgreSQL database, you should use the `org.postgresql/postgresql` JDBC driver.
