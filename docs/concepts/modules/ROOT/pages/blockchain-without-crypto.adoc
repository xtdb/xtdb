...
https://v1-docs.xtdb.com/clients/clojure/#_submit_tx[asynchronous],
https://v1-docs.xtdb.com/language-reference/datalog-transactions/[data-driven]
...
https://v1-docs.xtdb.com/concepts/strength-of-the-record/[records],
