...
The full website build/deploy is available (to JUXTers) in the private https://github.com/xtdb/xtdb-site[crux-site] repo - for more details, see the README over there.
