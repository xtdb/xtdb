...
This tutorial will install XTDB using the Clojure CLI tools. You can find in the other methods of installing XTDB in the xref:administration::installing.adoc[XTDB installation docs].
...
* xref:language-reference::datalog-queries.adoc[Native Datalog queries]
* xref:language-reference::sql-queries.adoc[SQL queries]
* xref:extensions::full-text-search.adoc[Full-text search with Apache Lucene]
* xref:language-reference::datalog-transactions.adoc#speculative-transactions[Speculative transactions]
