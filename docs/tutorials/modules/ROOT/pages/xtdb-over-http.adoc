...
This tutorial will install XTDB using the Clojure CLI tools. You can find in the other methods of installing XTDB in the https://xtdb.com/reference/installation.html[XTDB installation docs].
