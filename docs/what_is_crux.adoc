...
image::crux-venn-1.svg[Document database with graph queries,width=65%,align="center"]
...
critical requirement for systems any industry with strong auditing regulations,
