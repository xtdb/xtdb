...
To get started with the connector, there are two separate guides (depending on whether you are using a full *<<#confluent_quickstart,Confluent Platform>>* installation, or a basic *<<#kafka_quickstart,Kafka>>* installation):

[#confluent_quickstart]
include::{path}/Confluent-QuickStart.adoc[leveloffset=+1]

'''

[#kafka_quickstart]
include::{path}/Kafka-QuickStart.adoc[leveloffset=+1]
