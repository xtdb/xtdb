...
xref:integrations::sql.adoc[XTDB SQL module] with a SQL server _(open on port 1501)_.
...
See the xref:integrations::http.adoc[HTTP module documentation] for more information.
