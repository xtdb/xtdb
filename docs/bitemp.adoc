...
`put` (or `cas`) or deleted via `delete`.
...
Queries that use domain times do not automatically benefit from any kind of
native indexes to support efficient execution, however Crux encourages you to
build additional layers of functionality to do so. See <<#decorators,
Decorators>>.
...
[source,clj]
----
include::./src/docs/examples.clj[tags=bitemp0]
----
...
[source,clj]
----
include::./src/docs/examples.clj[tags=bitemp2]
----
...
[source,clj]
----
include::./src/docs/examples.clj[tags=bitemp3]
----
...
[source,clj]
----
include::./src/docs/examples.clj[tags=bitemp4]
----
...
[source,clj]
----
include::./src/docs/examples.clj[tags=bitemp4b]
----
...
[source,clj]
----
include::./src/docs/examples.clj[tags=bitemp4c]
----
...
[source,clj]
----
include::./src/docs/examples.clj[tags=bitemp5]
----
...
[source,clj]
----
include::./src/docs/examples.clj[tags=bitemp7]
----
...
[source,clj]
----
include::./src/docs/examples.clj[tags=bitemp8]
----
...
[source,clj]
----
include::./src/docs/examples.clj[tags=bitemp9]
----
...
[source,clj]
----
include::./src/docs/examples.clj[tags=bitemp10]
----
...
[source,clj]
----
include::./src/docs/examples.clj[tags=bitemp11]
----
...
[source,clj]
----
include::./src/docs/examples.clj[tags=bitemp12]
----
...
[source,clj]
----
include::./src/docs/examples.clj[tags=bitempq]
----
...
[source,clj]
----
include::./src/docs/examples.clj[tags=bitempr]
----
