...
APIs. To gain an understanding of edn see xref:tutorials#essential-edn[Essential EDN for Crux].Crux>>.
...
[source,clj]
----
include::example$examples.clj[tags=query-input]
----
...
[source,clj]
----
include::example$examples.clj[tags=basic-query]
----
...
Passing the query into `crux.api/q` (see how to xref:get_started#query[submit a query] in 'Get Started'), you get an edn result set containing the value `:smith`

[source,clj]
----
include::example$examples.clj[tags=basic-query-r]
----
...
[source,clj]
----
include::example$examples.clj[tags=query-with-arguments1]
----
...
[source,clj]
----
include::example$examples.clj[tags=query-with-arguments1-r]
----
...
[source,clj]
----
include::example$examples.clj[tags=query-with-arguments2]
----
...
[source,clj]
----
include::example$examples.clj[tags=query-with-arguments2-r]
----
...
[source,clj]
----
include::example$examples.clj[tags=query-with-arguments3]
----
...
[source,clj]
----
include::example$examples.clj[tags=query-with-arguments3-r]
----

[source,clj]
----
include::example$examples.clj[tags=query-with-arguments4-r]
----
...
[source,clj]
----
include::example$examples.clj[tags=query-with-arguments5]
----
...
[source,clj]
----
include::example$examples.clj[tags=query-with-arguments5-r]
----
...
[source,clj]
----
include::example$examples.clj[tags=query-with-arguments4]
----
...
[source,clj]
----
include::example$examples.clj[tags=query-with-pred-1]
----

Result:
[source,clj]
----
include::example$examples.clj[tags=query-with-pred-1-r]
----
...
[source,clj]
----
include::example$examples.clj[tags=query-at-t-d1]
----
...
[source,clj]
----
include::example$examples.clj[tags=query-at-t-d2]
----
...
[source,clj]
----
include::example$examples.clj[tags=query-at-t-q1]
----
...
[source,clj]
----
include::example$examples.clj[tags=query-at-t-q1-q]
----

Result Set:
[source,clj]
----
include::example$examples.clj[tags=query-at-t-q1-r]
----
...
[source,clj]
----
include::example$examples.clj[tags=query-at-t-q2-q]
----

Result Set:
[source,clj]
----
include::example$examples.clj[tags=query-at-t-q2-r]
----
...
[source,clj]
----
include::example$examples.clj[tags=join-d]
----

We can run a query to return a set of tuples that satisfy the join on the attribute `:name`
[source,clj]
----
include::example$examples.clj[tags=join-q]
----

Result Set:
[source,clj]
----
include::example$examples.clj[tags=join-r]
----
...
[source,clj]
----
include::example$examples.clj[tags=join2-d]
----

We can run a query to return a set of entities that `:follows` the set of entities with the `:name` value of `"Ivan"`
[source,clj]
----
include::example$examples.clj[tags=join2-q]
----

Result Set:
[source,clj]
----
include::example$examples.clj[tags=join2-r]
----
...
[source,clj,indent=0]
----
include::example$examples.clj[tags=streaming-query]
----
...
[source,clj]
----
include::example$examples.clj[tags=history-full]
----
...
[source,clj]
----
include::example$examples.clj[tags=history-range]
----
