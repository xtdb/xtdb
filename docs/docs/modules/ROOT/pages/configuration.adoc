...
[source,clj]
----
include::example$examples.clj[tags=close-node]
----
...
[source,clj]
----
include::example$examples.clj[tags=start-standalone-with-rocks]
----
...
[source,clj]
----
include::example$examples.clj[tags=start-standalone-with-lmdb]
----
...
[source,clj]
----
include::example$examples.clj[tags=start-cluster-node]
----
...
[source,clj]
----
include::example$examples.clj[tags=require-ek]

include::example$examples.clj[tags=ek-example]
----
...
[source,clj]
----
include::example$examples.clj[tags=ek-close]
----
...
[source,clj]
----
include::example$examples.clj[tags=start-jdbc-node]
----
...
[source,clj]
----
include::example$examples.clj[tags=start-standalone-http-node]
----
...
[source,clj]
----
include::example$examples.clj[tags=start-http-client]
----
