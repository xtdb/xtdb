...
- *EDN* – the extensible data notation format used throughout the Crux APIs, see xref:tutorials#essential-edn[Essential EDN for Crux].
...
[source,clj]
----
include::example$examples.clj[tags=include-crux-api]

include::example$examples.clj[tags=start-standalone-node]
----
...
[source,clj]
----
include::example$examples.clj[tags=submit-tx]
----
...
[source,clj]
----
include::example$examples.clj[tags=query]
----
...
[source,clj]
----
include::example$examples.clj[tags=should-get]
----

An entity query would be:
[source,clj]
----
include::example$examples.clj[tags=query-entity]
----
You should get:

[source,clj]
----
include::example$examples.clj[tags=should-get-entity]
----

[#next-steps]
== Next Steps

Now you know the basics of how to interact with Crux you may want to dive into our xref:tutorials.adoc[tutorials] below. Otherwise, let's take a look at further options for xref:configuration.adoc[setting up Crux].
