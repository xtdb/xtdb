...
Does XTDB provide transaction functions?::
  ...
  Yes - read more about transaction functions in XTDB xref:reference::transactions#transaction-functions[**here**].
