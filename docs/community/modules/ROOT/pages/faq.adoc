...
"types" regarding the shapes of documents you save. However, some users to find it
...
performance bottleneck on Crux versions prior to `21.05-1.17.0`. In the example
below, `:my.custom.ns` is an example namespace which would likely correspond to
the name of the system using Crux:
