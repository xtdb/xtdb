...
easy way to get familiar with XTDB in a minimal production-like environment. The section "Advanced XTDB
Configuration" below contains more advanced configuration options.

This guide was extracted from the "XTDB-in-a-Box" guide, which has minimal (working) project examples for Clojure
and Java you can see in the https://github.com/deobald/crux-in-a-box[crux-in-a-box] GitHub repo. If you prefer to
see all the code at once, head there first.
We also have thorough link:https://xtdb.com/docs/[Reference Docs], if that's your speed.
...
xref:administration::installing.adoc[Installing] page.
+++ </div></details> +++
...
xref:storage::index.adoc[list of available modules], each with instructions on
...
xref:language-reference::datalog-transactions.adoc[Transactions].
+++ </div></details> +++
...
read more in
xref:language-reference::datalog-queries.adoc[Datalog Queries] and
xref:language-reference::sql-queries.adoc[SQL Queries].
+++ </div></details> +++
...
link:https://xtdb.com/docs/[Reference Docs] or try
the https://www.xtdb.com/tutorials[Tutorial]. We also have https://www.xtdb.com/articles[Articles] and
https://www.xtdb.com/blog/index.html[blog posts] talking about the philosophy and history of XTDB. If you are feeling
particularly excited, you can browse our https://www.xtdb.com/articles/references.html[Bibliography].
