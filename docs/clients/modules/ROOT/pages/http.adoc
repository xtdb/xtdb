...
To configure your HTTP module, see the
xref:extensions::http.adoc[HTTP module documentation].

There is also an link:https://docs.xtdb.com/clients/http/openapi[OpenAPI Reference]
