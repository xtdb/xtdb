...
Individual endpoints may return additional types - see their docs below, or see the OpenAPI documentation link:https://xtdb-api-docs.s3.eu-west-1.amazonaws.com/redoc/{xtdb_version}/xtdb-redoc.html[here].
