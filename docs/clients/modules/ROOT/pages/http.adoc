...
To configure your HTTP module, see the xref:{page-component-version}@extensions::http.adoc[HTTP module documentation].

There is also an link:https://v1-docs.xtdb.com/clients/http/openapi/{xtdb_version}[OpenAPI Reference] describing the HTTP endpoint.
...
Individual endpoints may return additional types - see their docs below, or see the link:https://v1-docs.xtdb.com/clients/http/openapi/{xtdb_version}[OpenAPI Reference].
...
Note:
xref:{page-component-version}@language-reference::datalog-transactions.adoc#transaction-functions[Transaction functions]
