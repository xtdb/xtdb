...
Use `confluent-hub install juxt/kafka-connect-crux:20.05-1.8.4-alpha` to download and install the connector from Confluent hub. The downloaded connector is then placed within your confluent install's _'share/confluent-hub-components'_ folder. +
...
juxt/crux-kafka {:mvn/version "20.05-1.8.4-alpha"}
