...
Use `confluent-hub install juxt/kafka-connect-crux:20.03-1.8.0-alpha` to download and install the connector from Confluent hub. The downloaded connector is then placed within your confluent install's _'share/confluent-hub-components'_ folder. +
...
juxt/crux-http-server {:mvn/version "20.03-1.8.0-alpha"}
