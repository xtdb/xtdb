...
Use `confluent-hub install juxt/kafka-connect-crux:19.12-1.6.0-alpha` to download and install the connector from Confluent hub. The downloaded connector is then placed within your confluent install's _'share/confluent-hub-components'_ folder. +
...
juxt/crux-kafka {:mvn/version "19.12-1.6.0-alpha"}
