...
Use `confluent-hub install juxt/kafka-connect-crux:20.05-1.8.3-alpha` to download and install the connector from Confluent hub. The downloaded connector is then placed within your confluent install's _'share/confluent-hub-components'_ folder. +
...
[source,clj]
----
juxt/crux-core {:mvn/version "20.05-1.8.3-alpha"}
juxt/crux-kafka {:mvn/version "20.05-1.8.3-alpha"}
juxt/crux-http-server {:mvn/version "20.05-1.8.3-alpha"}
juxt/crux-rocksdb {:mvn/version "20.05-1.8.3-alpha"}
----
