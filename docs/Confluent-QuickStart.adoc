...
Use `confluent-hub install juxt/kafka-connect-crux:20.06-1.9.1-beta` to download and install the connector from Confluent hub. The downloaded connector is then placed within your confluent install's _'share/confluent-hub-components'_ folder. +
...
juxt/crux-kafka {:mvn/version "20.06-1.9.1-beta"}
juxt/crux-http-server {:mvn/version "20.06-1.9.1-alpha"}
