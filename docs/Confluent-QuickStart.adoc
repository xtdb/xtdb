...
Use `confluent-hub install juxt/kafka-connect-crux:20.07-1.10.0-beta` to download and install the connector from Confluent hub. The downloaded connector is then placed within your confluent install's _'share/confluent-hub-components'_ folder. +
...
juxt/crux-kafka {:mvn/version "20.07-1.10.0-beta"}
