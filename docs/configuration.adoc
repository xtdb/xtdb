...
|<<#standalone, Standalone>>|Uses local event log|`Crux.startStandaloneNode options;`
|<<#kafka, Cluster>>|Uses Kafka|`Crux.startClusterNode options;`
|<<#jdbc, JDBC>>|Uses JDBC event log|`Crux.startJDBCNode options;`
|===
