...
Note, that depending on your setup, other dependencies will be
required as described in this guide.
...
[source,clj]
----
include::../dev/examples.clj[tags=close-system]
----
...
Add Kafka to your project dependencies:
...
[source,clj]
----
include::../dev/examples.clj[tags=ek-example]
----
...
[source,clj]
----
include::../dev/examples.clj[tags=ek-close]
----
...
[source,clj]
----
include::../dev/examples.clj[tags=ln-example]
----
...
[source,clj]
----
include::../dev/examples.clj[tags=ln-close]
----
...
NOTE: TODO: rewrite this bit of the documentation to not use the dev.clj,
but rather a built example using Stuart Sierras Component lib (or
Integrant).
