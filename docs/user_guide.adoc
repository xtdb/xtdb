...
simple query. There're however a few things you might need to know first.

=== Prerequisites

- Make sure you understand *EDN* – the extensible data notation. https://github.com/edn-format/edn[Link].

- Have some basic understanding of *Datalog*. Crux supports an EDN-flavoured version of Datalog.
  You can find some prolific training http://www.learndatalogtoday.org/chapter/1[here].

- Concept of database temporality and consequent <<bitemp#bitemp-why,bitemporality>>.
