...
[source,clj]
----
include::./query_examples.clj[tags=query-input]
----
...
[source,clj]
----
include::./query_examples.clj[tags=basic-query]
----
...
corresponding value to `n`. Since all 3 entities in our database have a
...
[source,clj]
----
include::./query_examples.clj[tags=basic-query-r]
----
...
[source,clj]
----
include::./query_examples.clj[tags=query-with-arguments1]
----
...
[source,clj]
----
include::./query_examples.clj[tags=query-with-arguments1-r]
----
...
[source,clj]
----
include::./query_examples.clj[tags=query-with-arguments2]
----
...
[source,clj]
----
include::./query_examples.clj[tags=query-with-arguments2-r]
----
...
[source,clj]
----
include::./query_examples.clj[tags=query-with-arguments3]
----
...
[source,clj]
----
include::./query_examples.clj[tags=query-with-arguments3-r]
----
...
[source,clj]
----
include::./query_examples.clj[tags=query-with-arguments4]
----
...
[source,clj]
----
include::./query_examples.clj[tags=query-with-arguments4-r]
----
...
[source,clj]
----
include::./query_examples.clj[tags=query-with-arguments5]
----
...
[source,clj]
----
include::./query_examples.clj[tags=query-with-arguments5-r]
----
...
[source,clj]
----
include::./query_examples.clj[tags=query-at-t-d1]
----
...
[source,clj]
----
include::./query_examples.clj[tags=query-at-t-d2]
----
...
[source,clj]
----
include::./query_examples.clj[tags=query-at-t-q1]
----
...
[source,clj]
----
include::./query_examples.clj[tags=query-at-t-q1-q]
----

Result Set:
[source,clj]
----
include::./query_examples.clj[tags=query-at-t-q1-r]
----
...
[source,clj]
----
include::./query_examples.clj[tags=query-at-t-q2-q]
----

Result Set:
[source,clj]
----
include::./query_examples.clj[tags=query-at-t-q2-r]
----
...
[source,clj]
----
include::./query_examples.clj[tags=history-full]
----
...
[source,clj]
----
include::./query_examples.clj[tags=history-range]
----
...
[source,clj]
----
include::./query_examples.clj[tags=join-d]
----

We can run a query to return a set of tuples that satisfy the join on the attribute `:name`
[source,clj]
----
include::./query_examples.clj[tags=join-q]
----

Result Set:
[source,clj]
----
include::./query_examples.clj[tags=join-r]
----
...
[source,clj]
----
include::./query_examples.clj[tags=join2-d]
----

We can run a query to return a set of entities that `:follows` the set of entities with the `:name` value of `"Ivan"`
[source,clj]
----
include::./query_examples.clj[tags=join2-q]
----

Result Set:
[source,clj]
----
include::./query_examples.clj[tags=join2-r]
----
