...
Crux allows to retrieve all versions of a document
[source,clj]
----
...
_DataScript_ test queries such as "Rule with branches" and "Mutually recursive rules" work correctly with Crux and demonstrate advanced query patterns. See the Crux tests for details.
