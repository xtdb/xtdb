= Datalog Queries
:page-aliases: 1.20.0@reference::queries.adoc
...
To understand how Datalog works, read the _Learn XTDB Datalog Today_ tutorial from the https://docs.xtdb.com/tutorials/[Tutorials page].
