...
Crux is optimised for efficient and globally consistent point-in-time queries
...
One or more documents may be inserted into Crux via a `put` transaction at a
...
[source,clj]
----
include::example$test/crux/docs/examples/bitemporality_test.clj[tags=bitemp0,indent=0]

include::example$test/crux/docs/examples/bitemporality_test.clj[tags=bitemp1,indent=0]
----
...
[source,clj]
----
include::example$test/crux/docs/examples/bitemporality_test.clj[tags=bitemp2,indent=0]
----
...
[source,clj]
----
include::example$test/crux/docs/examples/bitemporality_test.clj[tags=bitemp3,indent=0]
----
...
[source,clj]
----
include::example$test/crux/docs/examples/bitemporality_test.clj[tags=bitemp4,indent=0]
----
...
[source,clj]
----
include::example$test/crux/docs/examples/bitemporality_test.clj[tags=bitemp4b,indent=0]
----
...
[source,clj]
----
include::example$test/crux/docs/examples/bitemporality_test.clj[tags=bitemp4c,indent=0]

include::example$test/crux/docs/examples/bitemporality_test.clj[tags=bitemp4d,indent=0]
----
...
[source,clj]
----
include::example$test/crux/docs/examples/bitemporality_test.clj[tags=bitemp5,indent=0]
----
...
[source,clj]
----
include::example$test/crux/docs/examples/bitemporality_test.clj[tags=bitemp7a,indent=0]

include::example$test/crux/docs/examples/bitemporality_test.clj[tags=bitemp7b,indent=0]
----
...
[source,clj]
----
include::example$test/crux/docs/examples/bitemporality_test.clj[tags=bitemp8a,indent=0]

include::example$test/crux/docs/examples/bitemporality_test.clj[tags=bitemp8b,indent=0]
----
...
[source,clj]
----
include::example$test/crux/docs/examples/bitemporality_test.clj[tags=bitemp9,indent=0]
----
...
[source,clj]
----
include::example$test/crux/docs/examples/bitemporality_test.clj[tags=bitemp10,indent=0]
----
...
[source,clj]
----
include::example$test/crux/docs/examples/bitemporality_test.clj[tags=bitemp11,indent=0]
----
...
[source,clj]
----
include::example$test/crux/docs/examples/bitemporality_test.clj[tags=bitemp12,indent=0]
----
...
[source,clj]
----
include::example$test/crux/docs/examples/bitemporality_test.clj[tags=bitempq-a,indent=0]
include::example$test/crux/docs/examples/bitemporality_test.clj[tags=bitempq-b,indent=12]
include::example$test/crux/docs/examples/bitemporality_test.clj[tags=bitempq-c,indent=2]
----
...
[source,clj]
----
include::example$test/crux/docs/examples/bitemporality_test.clj[tags=bitempr]
----
...
At a theoretical level Crux has similar properties to
...
representation of valid time in the indexes makes Crux "fully retroactive",
which is analogous to partial persistence in the temporal dimension, and
enables globally-consistent reads.

Crux does not natively implement "non-oblivious retroactivity" (i.e. persisted
