...
* https://opencrux.com/blog/crux-sql.html[Crux SQL: Query your Datalog database with SQL], Pither. Crux Blog. 2020.
* https://juxt.pro/blog/value-of-bitemporality[The Value of Bitemporality], Pither. JUXT Blog. 2019.
* https://www.youtube.com/watch?v=Zn-J26PGugM[Introducing Crux: A Bitemporal Database], Taylor, Pither. Scala in the City (YouTube). October 2019.
