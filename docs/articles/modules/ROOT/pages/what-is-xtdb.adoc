...
image::xtdb-node-1.svg?sanitize=true[XTDB Kafka Node Diagram,970,443]

XTDB is an open source document database with bitemporal graph queries.

image::xtdb-venn-1.svg?sanitize=true[Document database with graph queries,450,320,align="center"]
