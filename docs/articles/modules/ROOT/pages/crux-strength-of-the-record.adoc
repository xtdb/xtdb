...
footnote:simpledotorg[Rails example courtesy https://github.com/simpledotorg/simple-server/[simple.org], a life-saving project which makes effective use of ActiveRecord.]
