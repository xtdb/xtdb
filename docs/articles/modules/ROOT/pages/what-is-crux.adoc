= What is Crux?
:page-aliases: about::what-is-crux.adoc
...
image::crux-venn-1.svg?sanitize=true[Document database with graph queries,450,320,align="center"]
...
xref:bitemporality.adoc[Read more about Bitemporality in Crux] or specifically the
...
xref:reference::queries.adoc[Read more about how to query your data with Crux].
