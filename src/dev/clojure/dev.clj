...
'{:columns [{:table-oid 0, :column-attribute-number 0, :typlen 4, :type-modifier -1, :result-format :text, :column-oid 23, :column-name oid} {:table-oid 0, :column-attribute-number 0, :typlen -1, :type-modifier -1, :result-format :text, :column-oid 25, :column-name typname} {:table-oid 0, :column-attribute-number 0, :typlen -1, :type-modifier -1, :result-format :text, :column-oid 25, :column-name typsend} {:table-oid 0, :column-attribute-number 0, :typlen -1, :type-modifier -1, :result-format :text, :column-oid 25, :column-name typreceive} {:table-oid 0, :column-attribute-number 0, :typlen -1, :type-modifier -1, :result-format :text, :column-oid 25, :column-name typoutput} {:table-oid 0, :column-attribute-number 0, :typlen -1, :type-modifier -1, :result-format :text, :column-oid 25, :column-name typinput} {:table-oid 0, :column-attribute-number 0, :typlen 4, :type-modifier -1, :result-format :text, :column-oid 23, :column-name _column_7} {:table-oid 0, :column-attribute-number 0, :typlen 8, :type-modifier -1, :result-format :text, :column-oid 20, :column-name _column_8} {:table-oid 0, :column-attribute-number 0, :typlen 4, :type-modifier -1, :result-format :text, :column-oid 1007, :column-name _column_9}], :input-cols [{:pg-type :int4, :col-name oid, :result-format :text} {:pg-type :text, :col-name typname, :result-format :text} {:pg-type :text, :col-name typsend, :result-format :text} {:pg-type :text, :col-name typreceive, :result-format :text} {:pg-type :text, :col-name typoutput, :result-format :text} {:pg-type :text, :col-name typinput, :result-format :text} {:pg-type :int4, :col-name _column_7, :result-format :text} {:pg-type :int8, :col-name _column_8, :result-format :text} {:pg-type :_int4, :col-name _column_9, :result-format :text}]}
