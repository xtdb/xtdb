...
(t/deftest test-sql->static-ops-patch-null-valid-time-4448
  (t/is (= [{:op :patch-docs, :table-name 'public/foo, :docs [{"_id" 1}]
...
(t/deftest test-sql->static-ops-patch-5231
  (t/is (= [{:op :patch-docs, :table-name 'public/foo, :docs [{"_id" 1, "v" 2}]
  ...
  (t/is (= [{:op :patch-docs, :table-name 'public/foo, :docs [{"_id" 1, "v" 2} {"_id" 3, "v" 4}]
             :valid-from nil, :valid-to nil}]
  ...
  (t/testing "with param records"
    (t/is (= [{:op :patch-docs, :table-name 'public/bar, :docs [{"_id" 0, "value" "hola"} {"_id" 1, "value" "mundo"}]
               :valid-from nil, :valid-to nil}]
  ...
  (t/testing "parameterized valid-time groups across arg-rows"
    (t/is (= [{:op :patch-docs, :table-name 'public/foo, :docs [{"_id" 1}]
              ...
              {:op :patch-docs, :table-name 'public/foo, :docs [{"_id" 2}]
