...
(deftest test-pg-user
  ...
  (t/is (= {:user-id "xtdb"} (.verifyPassword (authn/<-node tu/*node*) "xtdb" "xtdb")))
  ...
  (t/is (= {:user-id "ada"} (.verifyPassword (authn/<-node tu/*node*) "ada" "lovelace")))
  ...
  (t/is (= {:user-id "anonymous"} (.verifyPassword (authn/<-node tu/*node*) "anonymous" "anonymous"))))
