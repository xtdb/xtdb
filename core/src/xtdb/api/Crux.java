...
public final class Crux {
    ...
    private static ICruxAPI startNode(Object config) {
        Object cruxNode = resolve("xtdb.api/start-node").invoke(config);
        return (ICruxAPI) resolve("xtdb.api.java/->JCruxNode").invoke(cruxNode);
    }
    ...
    public static ICruxAPI newApiClient(String url) {
        ...
        return (ICruxAPI) resolve("xtdb.api.java/->JCruxNode").invoke(apiClient);
    }
    ...
    public static ICruxAsyncIngestAPI newIngestClient(Map<?,?> options) {
        Object ingestClient = resolve("xtdb.ingest-client/open-ingest-client").invoke(options);
        return (ICruxAsyncIngestAPI) resolve("xtdb.api.java/->JCruxIngestClient").invoke(ingestClient);
    }
