...
(defmethod codegen-call [:dot_product :list :list] [{[[_ l-el-type] [_ r-el-type]] :arg-types}]
...
(defmethod codegen-call [:l2_distance :list :list] [{[[_ l-el-type] [_ r-el-type]] :arg-types}]
  (when-not (and (= l-el-type :f64) (= r-el-type :f64))
    (throw (err/illegal-arg :xtdb.expression/function-type-mismatch
...
(defmethod codegen-call [:cosine_distance :list :list] [{[[_ l-el-type] [_ r-el-type]] :arg-types}]
  (when-not (and (= l-el-type :f64) (= r-el-type :f64))
    (throw (err/illegal-arg :xtdb.expression/function-type-mismatch
