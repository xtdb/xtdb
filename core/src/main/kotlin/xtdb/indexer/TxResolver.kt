...
internal class TxResolver(
    ...
    /** Remove and return the head (oldest) tx, if any; ownership passes to the caller, which imports then closes it. */
    fun removeHead(): ResolvedTx? = queue.removeFirstOrNull()
