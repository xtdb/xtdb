...
data class TemporalBounds(
    ...
    fun overlapsSystemTime(other: TemporalBounds) = (systemFrom.intersects(other.systemFrom) || systemTo.intersects(other.systemTo))
    ...
    fun canBoundSystemTime(other: TemporalBounds) =  overlapsSystemTime(other) && systemTo.lower <= other.systemTo.upper
    fun canBound(other: TemporalBounds) = canBoundValidTime(other) && canBoundSystemTime(other)
