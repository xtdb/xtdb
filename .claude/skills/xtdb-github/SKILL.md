...
The chalk skills are generic — they come from the `xtdb/claude-plugins` marketplace — so everything XTDB-specific they need lives here, and it is the caller's job to pass it on.
