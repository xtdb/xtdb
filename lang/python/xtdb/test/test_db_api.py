...
def test_db_api_class(connection):
    connection.execute("INSERT INTO docs (_id, foo) VALUES (1, 'bar');")
...
def test_multiple_statements_db_api(connection):
    connection.execute("""INSERT INTO docs (_id, foo) VALUES (1, 'bar');
                    INSERT INTO docs (_id, foo) VALUES (1, 'baz');""")
...
def test_import_system_time_session_var_api(connection):
    connection.execute("INSERT INTO docs (_id, foo) VALUES (1, 'bang');")
...
def test_basis_session_var_api(connection):
    connection.execute("""SET import_system_time = '2020-01-02T12:34:56Z';
                    INSERT INTO docs (_id, foo) VALUES (1, 'bar');
                    INSERT INTO docs (_id, foo) VALUES (1, 'b;az');
                    """)

    connection.execute("""SET import_system_time = '2021-01-03T12:34:56Z';
                    INSERT INTO docs (_id, foo) VALUES (1, 'bang');
                    """)
...
def test_as_of_query(connection):
    connection.execute("SET import_system_time = '2020-01-01T00:00:00Z'; INSERT INTO trades (_id, price) VALUES (1, 100);")
    connection.execute("SET import_system_time = '2020-01-02T00:00:00Z'; INSERT INTO trades (_id, price) VALUES (1, 150);")

    result = connection.execute("SELECT _id, price FROM trades FOR SYSTEM_TIME AS OF DATE '2020-01-01';")
