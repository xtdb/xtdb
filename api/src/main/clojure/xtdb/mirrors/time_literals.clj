...
(do
  ...
  (defn instant [x] (Time/asInstant x))
  ...
  (defn zoned-date-time [x] (Time/asZonedDateTime x))
  (defn offset-date-time [x] (Time/asOffsetDateTime x))
  (defn date-time [x] (Time/asLocalDateTime x))
...
(def ^String print-date-time (partial print-to-string "ldt"))
(def ^String print-zoned-date-time (partial print-to-string "zdt"))
(def ^String print-offset-time (partial print-to-string "offset-time"))
(def ^String print-instant (partial print-to-string "instant"))
(def ^String print-offset-date-time (partial print-to-string "odt"))
