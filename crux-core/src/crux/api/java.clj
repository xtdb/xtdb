...
(defrecord JCruxDatasource [^java.io.Closeable datasource]
  ...
  (project [_ projection eid] (api/project datasource projection eid))
  (^java.util.List projectMany [_ projection ^Iterable eids] (api/project-many datasource projection eids))
  (^java.util.List projectMany [_ projection ^"[Ljava.lang.Object;" eids] (api/project-many datasource projection (seq eids)))
