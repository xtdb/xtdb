...
public interface ICruxAPI extends ICruxIngestAPI, Closeable {
     ...
     */
    public boolean hasTxCommitted(TransactionInstant submittedTx) throws NodeOutOfSyncException;
     ...
     */
    public TransactionInstant awaitTx(TransactionInstant tx, Duration timeout);
     ...
     */
    public TransactionInstant latestCompletedTx();

    /**
       @return the latest transaction to have been submitted to this cluster
    */
    public TransactionInstant latestSubmittedTx();
