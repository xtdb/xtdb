...
Within the main directory, a logging configuration file `logback.xml`, is included. As this is brought in by
the local `deps.edn`, you can edit the contents of the file and run `./bin/dev.sh` to change
logging options.
