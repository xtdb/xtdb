...
If you then go to http://localhost:3300/dashboards - you can log in (`admin/admin`) and work on/use the dashboards.

To view traces, use Grafana's Explore view with the Tempo data source at http://localhost:3300/explore.
