= XTQL Tutorial
:test: ../src/test/clojure/xtdb/tutorial_test.clj
...
----
include::{test}[tags=bo-json-1,string,indent=0]
----
+
[source,sql,string=unescape]
----
include::{test}[tags=bo-sql-1,string,indent=0]
----
+
...
[source,json,string=unescape]
----
include::{test}[tags=bo-json-2,indent=0]
----
+
[source,sql,string=unescape]
----
include::{test}[tags=bo-sql-2,indent=0]
----
+
...
[source,json,string=unescape]
----
include::{test}[tags=bo-json-3,indent=0]
----
+
[source,sql,string=unescape]
----
include::{test}[tags=bo-sql-3,indent=0]
----
...
[source,json,string=unescape]
----
include::{test}[tags=joins-json-1,indent=0]
----
+
[source,sql,string=unescape]
----
include::{test}[tags=joins-sql-1,indent=0]
----
...
[source,json,string=unescape]
----
include::{test}[tags=joins-json-2,indent=0]
----
+
[source,sql,string=unescape]
----
include::{test}[tags=joins-sql-2,indent=0]
----
+
...
[source,json,string=unescape]
----
include::{test}[tags=joins-json-3,indent=0]
----
+
[source,sql,string=unescape]
----
include::{test}[tags=joins-sql-3,indent=0]
----
+
...
[source,json,string=unescape]
----
include::{test}[tags=joins-json-4,indent=0]
----
+
[source,sql,string=unescape]
----
include::{test}[tags=joins-sql-4,indent=0]
----
+
...
[source,json,string=unescape]
----
include::{test}[tags=proj-json-1,indent=0]
----
+
[source,sql,string=unescape]
----
include::{test}[tags=proj-sql-1,indent=0]
----
+
...
[source,json,string=unescape]
----
include::{test}[tags=proj-json-2,indent=0]
----
+
[source,sql,string=unescape]
----
include::{test}[tags=proj-sql-2,indent=0]
----
...
[source,json,string=unescape]
----
include::{test}[tags=proj-json-3,indent=0]
----
+
[source,sql,string=unescape]
----
include::{test}[tags=proj-sql-3,indent=0]
----
...
[source,json,string=unescape]
----
include::{test}[tags=aggr-json-1,indent=0]
----

[source,sql,string=unescape]
----
include::{test}[tags=aggr-sql-1,indent=0]
----
...
[source,json,string=unescape]
----
include::{test}[tags=pull-json-1,indent=0]
----
...
[source,json,string=unescape]
----
include::{test}[tags=bitemp-json-1,indent=0]

include::{test}[tags=bitemp-json-2,indent=0]
----
+
[source,sql,string=unescape]
----
include::{test}[tags=bitemp-sql-1,indent=0]

include::{test}[tags=bitemp-sql-2,indent=0]
----
+
...
[source,json,string=unescape]
----
include::{test}[tags=bitemp-json-3,indent=0]
----
...
include::{test}[tags=DML-Insert-sql,indent=0]
----
...
[source,sql,string=unescape]
----
include::{test}[tags=DML-Delete-sql,indent=0]
----
+
...
[source,sql,string=unescape]
----
include::{test}[tags=DML-Delete-additional-unify-clauses-sql,indent=0]
----
+
...
[source,sql,string=unescape]
----
include::{test}[tags=DML-Delete-bitemporal-sql,indent=0]
----
+
...
[source,sql,string=unescape]
----
include::{test}[tags=DML-Delete-everything-sql,indent=0]
----
...
[source,sql,string=unescape]
----
include::{test}[tags=DML-Update-sql,indent=0]
----
+
...
[source,sql,string=unescape]
----
include::{test}[tags=DML-Update-bitemporal-sql-1,indent=0]

include::{test}[tags=DML-Update-bitemporal-sql-2,indent=0]
----
...
[source,sql,string=unescape]
----
include::{test}[tags=DML-Erase-sql,indent=0]
----
...
----
-- not implemented yet
include::{test}[tags=DML-Assert-sql,indent=0]
----
