...
Elide comments and docstrings that only describe the code under question or repeat the name of the function - assume that the reading developer is familiar with standard development practices.
DO write comments describing any non-standard practices, or anything that might be counter-intuitive.
e.g. "This is for performance, because ...", "see #bugnum", "this might be mutated by <...>"
