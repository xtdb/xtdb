...
We maintain a fork of [Arrow Java](https://github.com/apache/arrow-java) to fix a couple of issues in `DenseUnionVector` and commits that haven't made it into an arrow release yet - see [this diff](https://github.com/apache/arrow-java/compare/main...xtdb:main) for more details.
Clone the [XTDB fork](https://github.com/xtdb/arrow-java), add the [Arrow repo](https://github.com/apache/arrow-java) as remote.
