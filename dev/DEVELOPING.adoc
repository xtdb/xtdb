...
* https://circleci.com/gh/xtdb/core2[CircleCI build,window=_blank] image:https://circleci.com/gh/xtdb/core2.svg?style=svg&circle-token=867b84b6d1b4dfff332773f771457349529aee8b[]
...
Core2 uses Gradle[https://gradle.org/] - a JVM build tool that supports multi-module, polyglot projects.
...
** To run a single test file, run (e.g.) `./gradlew test --tests 'core2.api_test**'`
