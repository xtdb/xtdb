...
* Entry points:
** `xtdb-corda/src/main/kotlin/crux/corda/CruxCorda.kt` - entry point for the Crux driver, adds extension functions to `AppServiceHub`
** `xtdb-corda/src/main/clojure/crux/corda.clj` - the implementation of the Crux driver
** `xtdb-corda-state/src/main/kotlin/crux/corda/state/CruxState.kt` - interface that Corda states should implement to be included in Crux
* Example user app:
