...
cp clj-uberjar/$XTDB_EDN crux-builder/clj-uberjar/xtdb.edn
...
cp docker/$XTDB_EDN crux-builder/docker/xtdb.edn
...
cp mvn-uberjar/$XTDB_EDN crux-builder/mvn-uberjar/src/main/resources/xtdb.edn
