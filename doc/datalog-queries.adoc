...
XTDB 2.x no longer uses `clojure.core` as its standard library - instead, it has a link:./expressions.adoc[rich built-in standard library] drawn from the SQL:2011 specification.
