...
We will support https://standards.iso.org/ittf/PubliclyAvailableStandards/c060394_ISO_IEC_TR_19075-2_2015.zip[SQL:2011 temporal semantics] under the hood.
...
We should start using SQL:2011 terminology instead of Snodgrass everywhere for consistency:
