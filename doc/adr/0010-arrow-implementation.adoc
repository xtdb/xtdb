...
https://arrow.apache.org/docs/java/index.html[Arrow Java], which is
the official Arrow implementation for the JVM.
...
filtering. The https://arrow.apache.org/docs/format/Columnar.html#dense-union[Arrow Columnar Format]
