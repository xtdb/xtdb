...
For ease of implementation, we will initially implement option A.

We will later re-consider option B once we have landed option A, and are more familiar with the tradeoffs and nuances involved.
