...
(defn- ->override-bar3 {::sys/deps {::override-foo {:xtdb/module `->override-foo2, :arg :bar3-override}}} [opts] [:bar3 opts])
...
(t/deftest test-overriding
  ...
  (t/are [msg expected opts] (t/is (= expected
    ...
    {::override-foo {:xtdb/module `->override-foo2}}

    "user can override implementation and arg"
    {::override-foo [:foo2 {:arg :user-override}]}
    {::override-foo {:xtdb/module `->override-foo2, :arg :user-override}}
    ...
    {::override-bar {:xtdb/module `->override-bar2, ::override-foo {:arg :user-override}}}

    "bar2 - user can override nested implementation"
    {::override-bar [:bar2 {::override-foo [:foo2 {:arg :user-override}]}]}
    {::override-bar {:xtdb/module `->override-bar2,
                     ::override-foo {:xtdb/module ->override-foo2, :arg :user-override}}}
    ...
    {::override-bar {:xtdb/module `->override-bar3, ::override-foo {:arg :user-override}}}

    "bar3 - user can override nested config, but with strings"
    {::override-bar [:bar3 {::override-foo [:foo2 {:arg :user-override}]}]}
    {"xtdb.system-test/override-bar" {"xtdb/module" "xtdb.system-test/->override-bar3"
                                      "xtdb.system-test/override-foo" {"arg" "user-override"}}}

    "bar3 - user can override nested implementation"
    {::override-bar [:bar3 {::override-foo [:foo {:arg :user-override}]}]}
    {::override-bar {:xtdb/module `->override-bar3,
                     ::override-foo {:xtdb/module `->override-foo, :arg :user-override}}}))
