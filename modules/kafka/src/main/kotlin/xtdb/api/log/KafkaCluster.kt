...
// How long a one-shot read waits for the broker to answer. Not a cadence: nothing loops on it, and a
// tail's cadence is its caller's [Log.Tail.poll] timeout.
...
class KafkaCluster(
    ...
    data class ClusterFactory @JvmOverloads constructor(
        ...
        override fun open(): KafkaCluster =
            KafkaCluster(configMap, schemaRegistryUrl, coroutineContext)
    }
