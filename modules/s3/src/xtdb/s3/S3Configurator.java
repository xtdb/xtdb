...
class NippySerde {
    ...
    private static final IFn fastFreeze = (IFn) requiringResolve.invoke(Clojure.read("juxt.clojars.mirrors.nippy.v3v4v2.taoensso.nippy/fast-freeze"));
    private static final IFn fastThaw = (IFn) requiringResolve.invoke(Clojure.read("juxt.clojars.mirrors.nippy.v3v4v2.taoensso.nippy/fast-thaw"));
